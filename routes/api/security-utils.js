...
function generateToken(user) {
    // TODO: Add any data you want to keep in the JWT here... Modify to match User Model.
    // Hint: Look at reqUser in ./users.js and make sure that matches the User Model as well
    // Hint: Update validations.js as well to match User Model
    const data = {
